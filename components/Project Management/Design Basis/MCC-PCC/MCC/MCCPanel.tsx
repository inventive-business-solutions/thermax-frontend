...
import { getProjectListUrl, PROJECT_API } from "configs/api-endpoints"
...
const configItemValidationSchema = zod.object({
  ...
  pc_paint_shade_interior_exterior: zod.string({ required_error: "This field is required", message: "This field is required" }),
  pc_paint_shade_for_component: zod.string({ required_error: "This field is required", message: "This field is required" }),
  pc_paint_shade_for_base_frame: zod.string({ required_error: "This field is required", message: "This field is required" }),
  ...
  vfd_auto_manual_selection: zod.string({ required_error: "This field is required", message: "This field is required" }),
})
