...
const getDefaultValues = (plcData: any) => {
  return {
    ...
    is_rtd_tc_moduule_selected:
      plcData?.is_rtd_tc_moduule_selected?.toString() || "1",
    ...
    is_ups_battery_mounting_rack_selected:
      plcData?.is_ups_battery_mounting_rack_selected?.toString() || "1",
    plc_cpu_or_processor_module_or_series:
      plcData?.plc_cpu_or_processor_module_or_series || "VTS",
    is_bulk_power_supply_selected:
      plcData?.is_bulk_power_supply_selected?.toString() || "1",
    plc_communication_between_cpu_and_io_card:
      plcData?.plc_communication_between_cpu_and_io_card || "VTS",
    is_third_party_communication_protocol_selected:
      plcData?.is_third_party_communication_protocol_selected?.toString() ||
      "1",
    third_party_communication_protocol:
      plcData?.third_party_communication_protocol || "Ethernet",
    is_client_system_communication_selected:
      plcData?.is_client_system_communication_selected?.toString() || "1",
    client_system_communication: plcData?.client_system_communication || "FO",
    is_power_supply_redundancy_selected:
      plcData?.is_power_supply_redundancy_selected?.toString() || "1",
    is_cpu_redundancy_selected:
      plcData?.is_cpu_redundancy_selected?.toString() || "1",
    cpu_redundancy: plcData?.cpu_redundancy || "Hot",
    is_io_redundancy_selected:
      plcData?.is_io_redundancy_selected?.toString() || "1",
    is_cpu_and_io_card_redundancy_selected:
      plcData?.is_cpu_and_io_card_redundancy_selected?.toString() || "1",
    ...
    is_cpu_and_third_party_services_redundancy_selected:
      plcData?.is_cpu_and_third_party_services_redundancy_selected?.toString() ||
      "1",
    ...
    push_button_colour_acknowledge:
      plcData?.push_button_colour_acknowledge || "Black",
    ...
    indicating_lamp_colour_for_ups_power_supply:
      plcData?.indicating_lamp_colour_for_ups_power_supply || "Red",
    is_di_module_density_selected:
      plcData?.is_di_module_density_selected?.toString() || "1",
    di_module_density: plcData?.di_module_density || "16",
    is_di_module_input_type_selected:
      plcData?.is_di_module_input_type_selected?.toString() || "1",
    di_module_input_type: plcData?.di_module_input_type || "Sense Voltage",
    is_interrogation_voltage_selected:
      plcData?.is_interrogation_voltage_selected?.toString() || "1",
    interrogation_voltage: plcData?.interrogation_voltage || "24 VDC",
    di_module_scan_time: plcData?.di_module_scan_time || "VTS",
    is_do_module_density_selected:
      plcData?.is_do_module_density_selected?.toString() || "1",
    do_module_density: plcData?.do_module_density || "16",
    is_do_module_output_type_selected:
      plcData?.is_do_module_output_type_selected?.toString() || "1",
    ...
    is_no_of_contact_selected:
      plcData?.is_no_of_contact_selected?.toString() || "1",
    do_module_no_of_contact: plcData?.do_module_no_of_contact || "1NO + 1NC",
    output_status_on_processor_or_module_failure:
      plcData?.output_status_on_processor_or_module_failure ||
      "Output shall change to fail-safe position",
    is_ai_module_density_selected:
      plcData?.is_ai_module_density_selected?.toString() || "1",
    ai_module_density: plcData?.ai_module_density || "16",
    is_ai_module_output_type_selected:
      plcData?.is_ai_module_output_type_selected?.toString() || "1",
    ...
    is_rtd_tc_module_density_selected:
      plcData?.is_rtd_tc_module_density_selected?.toString() || "1",
    rtd_tc_module_density: plcData?.rtd_tc_module_density || "16",
    is_rtd_tc_module_input_type_selected:
      plcData?.is_rtd_tc_module_input_type_selected?.toString() || "1",
    ...
    is_rtd_tc_module_hart_protocol_support_selected:
      plcData?.is_rtd_tc_module_hart_protocol_support_selected?.toString() ||
      "1",
    is_ao_module_density_selected:
      plcData?.is_ao_module_density_selected?.toString() || "1",
    ao_module_density: plcData?.ao_module_density || "16",
    is_ao_module_output_type_selected:
      plcData?.is_ao_module_output_type_selected?.toString() || "1",
    ...
    is_plc_spare_io_count_selected:
      plcData?.is_plc_spare_io_count_selected?.toString() || "1",
    plc_spare_io_count: plcData?.plc_spare_io_count || "10%",
    is_plc_spare_memory_selected:
      plcData?.is_plc_spare_memory_selected?.toString() || "1",
    plc_spare_memory: plcData?.plc_spare_memory || "20%",
    is_no_of_hid_es_selected:
      plcData?.is_no_of_hid_es_selected?.toString() || "1",
    no_of_hid_es: plcData?.no_of_hid_es?.toString() || "1",
    is_no_of_hid_os_selected:
      plcData?.is_no_of_hid_os_selected?.toString() || "1",
    no_of_hid_os: plcData?.no_of_hid_os || 1,
    is_no_of_hid_hmi_selected:
      plcData?.is_no_of_hid_hmi_selected?.toString() || "1",
    no_of_hid_hmi: plcData?.no_of_hid_hmi || 1,
    is_hid_hmi_size_selected:
      plcData?.is_hid_hmi_size_selected?.toString() || "1",
    hid_hmi_size: plcData?.hid_hmi_size || "10",
    is_scada_development_license_selected:
      plcData?.is_scada_development_license_selected?.toString() || "1",
    no_of_scada_development_license:
      plcData?.no_of_scada_development_license?.toString() || "1",
    is_scada_runtime_license_selected:
      plcData?.is_scada_runtime_license_selected?.toString() || "1",
    no_of_scada_runtime_license: plcData?.no_of_scada_runtime_license || 1,
    is_hmi_development_license_selected:
      plcData?.is_hmi_development_license_selected?.toString() || "1",
    ...
    no_of_plc_programming_license_software:
      plcData?.no_of_plc_programming_license_software || 1,
    ...
    windows_operating_system:
      plcData?.windows_operating_system || "Windows Latest Version VTS",
    is_printer_with_cable_selected:
      plcData?.is_printer_with_cable_selected?.toString() || "1",
    printer_with_communication_cable:
      plcData?.printer_with_communication_cable || "A3 B/W",
    no_of_printer: plcData?.no_of_printer || 1,
    printer_cable: plcData?.printer_cable || "NA",
    is_furniture_for_scada_station_selected:
      plcData?.is_furniture_for_scada_station_selected?.toString() || "1",
    furniture_for_scada_station:
      plcData?.furniture_for_scada_station || "Console",
    ...
    hardware_between_plc_and_third_party:
      plcData?.hardware_between_plc_and_third_party || "Approx 50 meter",
...
const MCCcumPCCPLCPanel = ({
  ...
  const is_client_system_communication_selected_controlled = watch(
    "is_client_system_communication_selected"
  );
  const is_cpu_redundancy_selected_controlled = watch(
    "is_cpu_redundancy_selected"
  );
  const is_plc_and_ups_marshalling_cabinet_selected_controlled = watch(
    "is_plc_and_ups_marshalling_cabinet_selected"
  );
  const is_no_of_contact_selected_controlled = watch(
    "is_no_of_contact_selected"
  );
  const is_plc_spare_io_count_selected_controlled = watch(
    "is_plc_spare_io_count_selected"
  );
  const is_plc_spare_memory_selected_controlled = watch(
    "is_plc_spare_memory_selected"
  );
  const is_rtd_tc_moduule_selected_controlled = watch(
    "is_rtd_tc_moduule_selected"
  );
  ...
  const onSubmit = useCallback(async () => {
    ...
    try {
      ...
      if (mccPanelData1 && mccPanelData1.length > 0) {
        await updateData(
          `${MCC_PCC_PLC_PANEL_1}/${mccPanelData1[0].name}`,
          false,
          data
        );
      } else {
      ...
      if (mccPanelData2 && mccPanelData2.length > 0) {
        await updateData(
          `${MCC_PCC_PLC_PANEL_2}/${mccPanelData2[0].name}`,
          false,
          data
        );
      } else {
      ...
      <form onSubmit={onSubmit} className="flex flex-col gap-2 px-4">
          ...
          <div className="flex flex-1 flex-col gap-4">
            ...
            <div>
              <CustomSingleSelect
                ...
                size="small"
                disabled={
                  watch("is_third_party_communication_protocol_selected") ===
                  "0"
                }
              />
            </div>
          ...
          <div className="flex flex-1 flex-col gap-4">
            ...
            <div>
              <CustomSingleSelect
                ...
                size="small"
                disabled={
                  watch("is_client_system_communication_selected") === "0"
                }
              />
            </div>
          </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-1 items-center gap-2">
            <div className="flex flex-1 items-center gap-4">
              <h4 className="text-sm font-semibold text-slate-700">
                Marshalling Cabinet For PLC and UPS
              </h4>
              <div className="flex-1">
                <CustomRadioSelect
                  control={control}
              ...
              <div className="flex flex-1 items-end gap-2">
                ...
                <div className="flex-1">
                  <CustomSingleSelect
                    ...
                    disabled={
                      watch("is_interrogation_voltage_selected") === "0"
                    }
                  />
                </div>
              </div>
              ...
              <div className="flex flex-1 items-center gap-2">
                ...
                <div className="flex-1">
                  <CustomSingleSelect
                    ...
                    disabled={
                      watch("is_do_module_output_type_selected") === "0"
                    }
                  />
                </div>
              </div>
              ...
              <div className="flex flex-1 items-center gap-2">
                ...
                <div className="flex-1">
                  <CustomTextInput
                    ...
                    size="small"
                    disabled={
                      watch("is_ai_module_output_type_selected") === "0"
                    }
                  />
                </div>
              </div>
              ...
              <div className="flex flex-1 items-center gap-2">
                ...
                <div className="flex-1">
                  <CustomSingleSelect
                    ...
                    disabled={
                      watch("is_rtd_tc_module_density_selected") === "0" ||
                      isRtdModuleSelected === "0"
                    }
                  />
                </div>
              </div>
              <div className="flex flex-1 items-center gap-2">
                ...
                <div className="flex-1">
                  <CustomSingleSelect
                    ...
                    disabled={
                      watch("is_rtd_tc_module_input_type_selected") === "0" ||
                      isRtdModuleSelected === "0"
                    }
                  />
                </div>
              ...
              <div className="flex flex-1 items-center gap-2">
                ...
                <div className="flex-1">
                  <CustomSingleSelect
                    ...
                    disabled={
                      watch("is_ao_module_output_type_selected") === "0"
                    }
                  />
                </div>
              </div>
        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-1 items-center gap-2">
              ...
              <div className="flex-1">
                <CustomTextNumber
                  ...
                  size="small"
                  disabled={
                    watch("is_scada_development_license_selected") === "0"
                  }
                />
              </div>
            </div>
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex flex-1 items-center gap-2">
              ...
              <div className="flex-1">
                <CustomTextNumber
                  ...
                  label=""
                  disabled={
                    watch("is_hmi_development_license_selected") === "0"
                  }
                  size="small"
                />
              </div>
            ...
            <div className="flex flex-1 items-center gap-2">
              <div className="flex items-center gap-4">
                <h4 className="text-sm font-semibold text-slate-700">
                  PLC Programming License Software
                </h4>
                <div className="flex-1">
                  <CustomRadioSelect
                    control={control}
              ...
              <div className="flex-1">
                <CustomTextNumber
                  ...
                  size="small"
                  disabled={
                    watch("is_plc_programming_license_software_selected") ===
                    "0"
                  }
                />
              </div>
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="flex flex-1 items-center gap-2">
            <div className="flex items-center gap-4">
              <h4 className="text-sm font-semibold text-slate-700">
                Printer With Suitable Communication Cable
              </h4>
              <div className="flex-1">
                <CustomRadioSelect
                  control={control}
          ...
          <div className="flex flex-1 items-center gap-2">
            ...
            <div className="flex-1">
              <CustomSingleSelect
                ...
                disabled={
                  watch("is_furniture_for_scada_station_selected") === "0"
                }
              />
            </div>
          </div>
        ...
        <div className="flex gap-4">
          ...
          <div className="flex-1">
            <CustomTextInput
              control={control}
              name="iiot_requirement"
              label="IIOT requirement"
            />
          </div>
        </div>
        <div>
