...
const getDefaultValues = (
  ...
  return {
    ...
    is_under_or_over_voltage_selected:
      pccPanelData?.is_under_or_over_voltage_selected || 1,
    ...
    is_blue_cb_spring_charge_selected:
      pccPanelData?.is_blue_cb_spring_charge_selected?.toString() || "0",
    is_red_cb_in_service: pccPanelData?.is_red_cb_in_service?.toString() || "0",
    is_white_healthy_trip_circuit_selected:
      pccPanelData?.is_white_healthy_trip_circuit_selected?.toString() || "0",
    ...
    ga_pcc_construction_drawout_type:
      pccPanelData?.ga_pcc_construction_drawout_type || "Drawout Type",
    ...
    is_marshalling_section_selected:
      pccPanelData?.is_marshalling_section_selected || 1,
    ...
    ga_gland_plate_3mm_drill_type:
      pccPanelData?.ga_gland_plate_3mm_drill_type || "Drilled",
...
const PCCPanel = ({
  ...
  }, [getValues, revision_id, panel_id]);
